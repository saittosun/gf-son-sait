...
export class StripeComponent implements OnInit {
  ...
  pay(): void {
    if (this.stripeForm.valid) {
      this.isLoading = true;
      this.databaseHandlerService.addPaymentIntentStripe(this.data, this.stripePaymentIntent)
        .pipe(
          tap(stripePaymentIntent => this.stripePaymentIntent = stripePaymentIntent),
